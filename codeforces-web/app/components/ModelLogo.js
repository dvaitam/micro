const MODEL_LOGOS = [
  ...
  { match: 'kimi', logo: 'https://statics.moonshot.cn/moonshot-ai/favicon.ico' },
  { match: 'moonshotai', logo: 'https://statics.moonshot.cn/moonshot-ai/favicon.ico' },
  { match: 'grok', logo: 'https://x.ai/favicon.ico' },
  { match: 'xai', logo: 'https://x.ai/favicon.ico' },
  { match: 'gpt', logo: 'https://openai.com/favicon.ico' },
  { match: 'openai', logo: 'https://openai.com/favicon.ico' },
  { match: 'o1', logo: 'https://openai.com/favicon.ico' },
  { match: 'o3', logo: 'https://openai.com/favicon.ico' },
  { match: 'o4', logo: 'https://openai.com/favicon.ico' },
